...
public class RecepientServiceImpl implements RecepientService {
			...
			throws InvalidBloodTypeException
	{
		// TODO Auto-generated method stub
			RecepientDAO recepientDAO=new RecepientDAOImpl();
			List<Recepients> allRecepientDetails = null;
			if(RecepientBloodGroup!=null)
			{
				allRecepientDetails = recepientDAO.sortingBasedOnRecepientBloodGroup(RecepientBloodGroup);
				return allRecepientDetails;
			}
			else return null;
		}

	public List<Recepients> sortingBasedOnRecepientBloodGroup() throws InvalidBloodTypeException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List<Recepients> getRecepientDetailsList() {
		...
		if(true)
		{
			allRecepientDetails = recepientDAO.getRecepientDetailsList();
			return allRecepientDetails;
		}
		else return null;
	}
	...
	public List<Recepients> sortingRBasedOnLocation(String Location) {
		...
		List<Recepients> allRecepientDetails = null;
		if (Location != null) {
			allRecepientDetails = recepientDAO.sortingRBasedOnLocation(Location);
			return allRecepientDetails;
		} else
			return null;
	}
