...
public class DonorServiceImpl implements DonorService {
	...
	public List<Donor> sortingBasedOnBloodGroup(String BloodGroup) throws InvalidBloodTypeException
	{
		// TODO Auto-generated method stub
			...
			if(BloodGroup!=null)
			{
				allDonorDetails = donorDAO.sortingBasedOnBloodGroup(BloodGroup);
				return allDonorDetails;
			}
			else return null;
		}

	public List<Donor> sortingBasedOnBloodGroup() throws InvalidBloodTypeException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List<Donor> getDonorDetailsList() {
		...
		if(true)
		{
			allDonorDetails = donorDAO.getDonorDetailsList();
			return allDonorDetails;
		}
		else return null;
	...
	public List<Donor> sortingBasedOnLocation(String Location) {
		...
		List<Donor> allDonorDetails = null;
		if (Location != null) {
			allDonorDetails = donorDAO.sortingBasedOnLocation(Location);
			return allDonorDetails;
		} else
			return null;
	}
